...
Purpose: Consistent visual structure across modes - files first with directory labels, hash as trailing detail. This completes the output unification work started in Phase 7.
