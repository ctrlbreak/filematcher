...
CRITICAL: The "No duplicates found." case and blank lines between groups are NOT in the formatter - they remain as direct print() calls. This is intentional to minimize refactoring scope while ensuring byte-identical output.
  </action>
  <verify>
```bash
...
Should show PREVIEW banner and duplicate groups.
  ...
  <done>Preview mode output routes through TextActionFormatter</done>
</task>
