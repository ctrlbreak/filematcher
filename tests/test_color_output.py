...
class TestTerminalRowCalculation(unittest.TestCase):
    ...
    def test_strip_ansi_removes_color_codes(self):
        ...
        from filematcher import strip_ansi, GREEN, RESET, BOLD_GREEN
    ...
    def test_visible_len_plain_text(self):
        ...
        from filematcher import visible_len
    ...
    def test_visible_len_with_ansi(self):
        ...
        from filematcher import visible_len, GREEN, RESET, BOLD_GREEN, YELLOW
    ...
    def test_terminal_rows_short_line(self):
        ...
        from filematcher import terminal_rows_for_line
    ...
    def test_terminal_rows_excludes_ansi_codes(self):
        ...
        from filematcher import terminal_rows_for_line, GREEN, RESET
